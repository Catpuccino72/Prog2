...
public class UnsortedIntBinTreeNode extends IntBinTreeNode {
  private static Random rand; // nicht initialisiert

  public UnsortedIntBinTreeNode(int content, SortedIntBinTreeNode left, SortedIntBinTreeNode right) { // Constructor fehlte
